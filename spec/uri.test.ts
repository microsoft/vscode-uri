...
suite('URI', () => {
	...
	test('from', () => { 
		assert.throws(() => Uri.from(undefined));
		assert.throws(() => Uri.from({scheme: 'file', path: '//foo/bar'}));
	...
	test('toString, http and query', function () {
